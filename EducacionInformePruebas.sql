...
where 
p.Id_Regional=1637 -- florencia  --4521 Popayan
and p.Fecha_Atencion>='20151001' and p.Fecha_Atencion<='20151031'
and p.Estudia_PE='Si' and p.Municipio_PE=p.MunicipioAtencion and not p.Certificado_PE='Si'
