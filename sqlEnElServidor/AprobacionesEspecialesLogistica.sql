...
Aprobacion_Logistica_Ofc=null,
Aprobacion_Finanzas_Ofc=null
where Numero=@Numero

select * from OrdenCompra oc where oc.Numero=@Numero or  oc.Numero='OCBOG9065' or oc.Numero='OCBOG9020'
