use IRDCOL
declare  @MuncipioAtencion varchar(20) = 'Popayán';
declare  @FechaAtencionInicial varchar(8) = '20151001';
declare  @FechaAtencionFinal varchar(8) = '20160930';
