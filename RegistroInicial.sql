...
declare  @Fecha_Radicacion_Final varchar(8) = '20170430';
...
coalesce(EstadoPAARI.Descripcion,'') as 'Diagnostico_Asistencia(PAARI,FC,RegAdmon)',  -- Estado_PAARI,
convert(date,PAARI.Fecha_Inclusion) as Fecha_Aplicacion_Diagnostico_Asistencia, -- PAARI,
convert(date,PAARI.Fecha_Investigacion) as Fecha_Investigacion_Diagnostico_Asistencia,
